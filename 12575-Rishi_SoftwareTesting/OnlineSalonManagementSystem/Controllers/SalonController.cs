...
namespace OnlineSalonManagementSystem.Controllers
{
    public class SalonController : Controller
    {
        ...
        public SalonController(OnlineSalonManagementDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,Phone,Email,Website")] Salon salon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Phone,Email,Website")] Salon salon)
        {
            if (id != salon.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateConcurrencyException)
                {
                    ...
                    {
                        TempData["ErrorMessage"] = "Error occurred while updating the salon";
                        throw;
                    }
                }
                return RedirectToAction(nameof(Index));
