...
var prodish=document.getElementById("prodis") as HTMLInputElement;

bt1.addEventListener("click",(e)=>{
    e.preventDefault();
    var p1=new Product();
    p1.prodis({name:name.value,price:parseInt(price.value),isStock:stock.checked});
    prodish.innerHTML="<p>Product name is "+name.value+" and price is "+price.value+" and stock is "+stock.checked+"</p>";
})
