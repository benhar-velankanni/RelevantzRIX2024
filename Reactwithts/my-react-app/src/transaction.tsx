...
const TransactionManagement: React.FC = () => {
  ...
  return (
    <div className="ui container">
      <h1 className="ui dividing header massive text">Transaction Management</h1>
      <form onSubmit={handleSubmit} className="ui form segment raised">
        <table className="ui table celled">
          <tbody>
            <tr>
              <td className="collapsing"><label>Transaction Id: </label></td>
            ...
            <tr>
              <td className="collapsing"><label>Description: </label></td>
            ...
            <tr>
              <td className="collapsing"><label>Amount: </label></td>
            ...
            <tr>
              <td className="collapsing"><label>Date: </label></td>
            ...
            <tr>
              <td></td>
              <td><button type="submit" id="add" className="ui primary button">{transaction.id ? 'Update' : 'Add'}</button></td>
            </tr>
          </tbody>
        </table>
      </form>
      <div className="ui action input">
        ...
        <button className="ui button" onClick={handleSearch} > <i className="search icon"></i>  Search</button>
      </div>
