...
document.querySelector<HTMLDivElement>('#app')!.innerHTML = `
  <div>
    <h2>Use Constructor and Inheritance concept and implement the function call to predict the expected out put all values</h2>
  </div>`
  ...
  let  p=new Product("Laptop", 50000, true);
  let  m=new Mobile("Laptop", 50000, true, "good");
