...
using Artdatabasefirst.Models;

namespace Artdatabasefirst
{
    public class Program
    {
        public static void Main(string[] args)
        {
            var context = new ArtdatabaseFirstDbContext();
        ...
        private static void UserMenu(ArtdatabaseFirstDbContext context)
        {
            int choice;
            do
            {
        ...
        private static void LessonMenu(ArtdatabaseFirstDbContext context)
        {
            int choice;
            do
            {
        ...
        private static void ChallengeMenu(ArtdatabaseFirstDbContext context)
        {
            int choice;
            do
            {
